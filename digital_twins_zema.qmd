...
This leads to the look-up table representing the relationships shown below 

:::{.panel-tabset}

# $\texttt{c}=1$

![Variations of `PS1`, `PS2`, `PS3` and `EPS1` as functions of the exogenous input `PS4` when the context variable is set to  $\texttt{c}=1$](images/lookup1.png)

# $\texttt{c}=0$

![Variations of `PS1`, `PS2`, `PS3` and `EPS1` as functions of the exogenous input `PS4` when the context variable is set to  $\texttt{c}=0$](images/lookup0.png)
