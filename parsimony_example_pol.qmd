...
![**Regression error**: (For instance, $e_y=0.1$ means that 95\% of the errors are 10 times lower than the median of the norm of $y$).](images/ey.png){width="55%"}
...
Obviously, the above tables show how bad is the generalization power of the DNN-based models. The non sparse solver remains quite good in the absence of noise and starts to be seriously deteriorated as soon as measurement noise is added. On the contrary, the sparse model resists in all circumstances. 
...
In the next [true/false anomaly section](state_context_anomalies.qmd), we dig a little bit deeper inside an equipment in order to understand what are the different reasons that induce ambiguity in the diagnosis of normality. 