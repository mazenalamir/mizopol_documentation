...
1. First an impicit piece-wise polynomial representation is obtained by using `pwpol`. This provides the set of polynomials $P_\sigma$ mentioned in @eq-residual-implicit.
...
More detailed are provided in the [`xpwpol`-dedicated section](xpwpol_intro.qmd).
