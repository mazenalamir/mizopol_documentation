...
Recall that the exhaustive and precise documentation of the API is proposed in the [API-documentation section](api-documentation-intro.qmd) and those which follow it. Here, only a use-case is presented in order to grasp a feeling of the capabilities of the `MizoPol` package. 
...
_Notice that in this case, the number of eligible monomials is equal to 11440_.
